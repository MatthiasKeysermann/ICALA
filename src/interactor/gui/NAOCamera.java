...
public class NAOCamera extends InteractorUDP {

	private final static String NAME = "NAOCamera";
	...
	private final static float BLUR_RADIUS = 4.0f; // 4.0f
	...
	protected double[] readInput() {
		...
		// recreate pattern
		pattern = getPattern(image, IMAGE_WIDTH, IMAGE_HEIGHT);
	...
	public static void main(String[] args) {
		NAOCamera interactor = new NAOCamera();
		interactor.run();
	}
