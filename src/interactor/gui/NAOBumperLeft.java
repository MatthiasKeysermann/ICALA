...
public class NAOBumperLeft extends InteractorUDP {

	private static final String NAME = "NAOBumperLeft";
	...
	public NAOBumperLeft() {
		...
		// create panel
		panel = new JPanel();
		panel.setBorder(BorderFactory.createTitledBorder("Bumper Left"));
		frame.add(panel);
	...
	protected double[] readInput() {
		...
		Variant varBumperLeft = memory.getData("LeftBumperPressed");
		double bumperLeft = (double) varBumperLeft.toFloat();

		// create pattern
		double[] pattern = new double[INPUT_DIM];
		pattern[0] = 0.5;
		pattern[1] = bumperLeft;
	...
	public static void main(String[] args) {
		NAOBumperLeft interactor = new NAOBumperLeft();
		interactor.run();
	}
