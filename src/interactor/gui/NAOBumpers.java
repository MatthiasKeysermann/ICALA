...
public class NAOBumpers extends InteractorUDP {

	private static final String NAME = "NAOBumpers";
	...
	public NAOBumpers() {
		...
		// create panel
		panel = new JPanel();
		panel.setBorder(BorderFactory.createTitledBorder("Bumpers"));
		frame.add(panel);
	...
	protected void updateUI() {
		...
		synchronized (panel) {
			...
			g.drawString(strLeft, (int) Math.round(width * 0.1), (int) Math.round(height * 0.9));
			String strRight = "Right";
			textWidth = metrics.stringWidth(strRight);
			g.drawString(strRight, (int) Math.round(width * 0.9) - textWidth, (int) Math.round(height * 0.1));
	...
	public static void main(String[] args) {
		NAOBumpers interactor = new NAOBumpers();
		interactor.run();
	}
