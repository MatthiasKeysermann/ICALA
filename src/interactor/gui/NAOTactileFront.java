...
public class NAOTactileFront extends InteractorUDP {

	private static final String NAME = "NAOTactileFront";
	...
	public NAOTactileFront() {
		...
		// create panel
		panel = new JPanel();
		panel.setBorder(BorderFactory.createTitledBorder("Tactile Front"));
		frame.add(panel);
	...
	public static void main(String[] args) {
		NAOTactileFront interactor = new NAOTactileFront();
		interactor.run();
	}
