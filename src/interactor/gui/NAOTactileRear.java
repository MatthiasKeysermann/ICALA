...
public class NAOTactileRear extends InteractorUDP {

	private static final String NAME = "NAOTactileRear";
	...
	public NAOTactileRear() {
		...
		// create panel
		panel = new JPanel();
		panel.setBorder(BorderFactory.createTitledBorder("Tactile Rear"));
		frame.add(panel);
	...
	protected void updateUI() {
		...
		synchronized (panel) {
			...
			String strNotTouched = "Not Touched";
			textWidth = metrics.stringWidth(strNotTouched);
			g.drawString(strNotTouched, (width - textWidth) / 2, (int) Math.round(height * 0.1));
			String strTouched = "Touched";
			textWidth = metrics.stringWidth(strTouched);
			g.drawString(strTouched, (width - textWidth) / 2, (int) Math.round(height * 0.9));
	...
	public static void main(String[] args) {
		NAOTactileRear interactor = new NAOTactileRear();
		interactor.run();
	}
