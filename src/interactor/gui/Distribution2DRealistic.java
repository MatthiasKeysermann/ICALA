...
public class Distribution2DRealistic extends InteractorUDP {

	private static final String NAME = "Distribution2DRealistic";

	private static final int INPUT_DIM = 2;

	private LinkedList<double[]> patterns;

	private static final double pChangePattern = 0.05;
	...
	public Distribution2DRealistic() {
		...
		topology.setPrintDebugInfo(true);
	...
	protected double[] readInput() {
		...
		// change pattern
		if (random.nextDouble() < pChangePattern) {
	...
	public static void main(String[] args) {
		Distribution2DRealistic distribution2DRealistic = new Distribution2DRealistic();
		distribution2DRealistic.run();
	}
