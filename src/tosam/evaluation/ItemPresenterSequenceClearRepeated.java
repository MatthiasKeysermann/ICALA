...
public class ItemPresenterSequenceClearRepeated extends SenderUDP {
	...
	public ItemPresenterSequenceClearRepeated() {
		super("ItemPresenter");
	...
	public static void main(String[] args) {
		ItemPresenterSequenceClearRepeated itemPresenter = new ItemPresenterSequenceClearRepeated();

		ArrayList<String[]> sequences = new ArrayList<String[]>();
		String[] sequenceRepeated = { "A", "B", "X", "D", "E", "F", "G", "X", "I", "J" };
		sequences.add(sequenceRepeated);
		int cyclesItem = 10;
		int cyclesGap = 2;
		int repetitions = 25;
		int cyclesCue = 0;
