...
/**
 * Class for a running TOSAM simulation.
 * <p>
...
public class Simulation implements Runnable {
	...
	protected static final long CYCLE_TIME_DEFAULT = 100; // milliseconds
	...
	private boolean printNetworkInfo;
	...
	public boolean isPrintNetworkInfo() {
		return printNetworkInfo;
	}

	public void setPrintNetworkInfo(boolean printNetworkInfo) {
		this.printNetworkInfo = printNetworkInfo;
	}
	...
	private void step() {
		...
		// decay activations
		network.decayActivations();

		// decay weights
		network.decayWeights();
