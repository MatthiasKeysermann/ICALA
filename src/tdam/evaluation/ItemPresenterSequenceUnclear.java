...
public class ItemPresenterSequenceUnclear extends SenderUDP {
	...
	public ItemPresenterSequenceUnclear() {
		super("ItemPresenterSequenceUnclear");
	...
	public static void main(String[] args) {
		ItemPresenterSequenceUnclear itemPresenter = new ItemPresenterSequenceUnclear();
